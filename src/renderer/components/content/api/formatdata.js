export default {
  boolean: '布尔类型,参考: https://github.com/nuysoft/Mock/wiki/Basic',
  natural: '随机的自然数（大于等于 0 的整数）,参考: https://github.com/nuysoft/Mock/wiki/Basic',
  integer: '随机的整数,参考: https://github.com/nuysoft/Mock/wiki/Basic',
  float: '随机的浮点数,参考: https://github.com/nuysoft/Mock/wiki/Basic',
  character: '随机字符,参考: https://github.com/nuysoft/Mock/wiki/Basic',
